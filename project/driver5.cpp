...
int main()
{
  ...
  cout << "rv from createDirectory /a is " << r <<(r==0 ? " correct": " fail") <<endl;
  ...
  cout << "rv from createFile /e/a/a is " << r <<(r==0 ? " correct": " fail") <<endl;
  ...
  cout << "rv from lockFile /h is " << l1 <<(l1>=0 ? " correct /h is locked, not /h directory": " fail") <<endl;
  ...
  cout << "rv from renameFile /h /x is " << r <<(r==-3 ? " correct /h is locked": " fail") <<endl;
  r = c1->myFS->renameDirectory(const_cast<char *>("/h"), 2, const_cast<char *>("/i"), 2);
  cout << "rv from renameDirectory /h /x is " << r <<(r==-3 ? " correct /i dir exists": " fail") <<endl;
  r = c1->myFS->renameDirectory(const_cast<char *>("/$"), 2, const_cast<char *>("/z"), 2);
  cout << "rv from renameDirectory /h /x is " << r <<(r==-1 ? " correct /$  invalid": " fail") <<endl;
  r = c1->myFS->renameDirectory(const_cast<char *>("/h"), 2, const_cast<char *>("/o"), 2);
  cout << "rv from renameDirectory /h /o is " << r <<(r==0 ? " correct": " fail") <<endl;
  r = c1->myFS->renameDirectory(const_cast<char *>("/i"), 2, const_cast<char *>("/o"), 2);
  cout << "rv from renameDirectory /h /o is " << r <<(r==-3 ? " correct /o exists": " fail") <<endl;
  ...
  cout << "rv from renameFile /h /o is " << r <<(r==0 ? " correct file /h": " fail") <<endl;
